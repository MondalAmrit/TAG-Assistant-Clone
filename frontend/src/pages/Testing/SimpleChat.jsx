...
export default function SimpleChat() {
    const [conversations, setConversations] = useState([
        {user:false, msg: 'Hi I am TAG - chatbot. How can I help you?', time: Date.now()},
    ]);
    ...
    return(
        <div className="mainWrapper">
            ...
            <div className="bgShapesContainer">
                <div className="diffShape" style={{top:'17%',left:'29%', width:'350px',height:'200px', 
                    background:`radial-gradient(rgba(${bgClr},0.9), rgba(${bgClr},0.5))`,boxShadow:`0 0 20px rgba(${bgClr},0.5)`}}></div>
                <div className="diffShape" style={{top:'24%',left:'27%', width:'200px',height:'270px', 
                    background:`radial-gradient(rgba(${bgClr},0.9), rgba(${bgClr},0.5))`,boxShadow:`0 0 20px rgba(${bgClr},0.5)`}}></div>
                <div className="diffShape" style={{top:'24%',left:'48%', width:'200px',height:'250px', 
                    background:`radial-gradient(rgba(${bgClr},0.9), rgba(${bgClr},0.5))`,boxShadow:`0 0 20px rgba(${bgClr},0.5)`}}></div>
            </div>
            <div className="mainContainer">
                ...
                <div className="TopSection">
                    ...
                    <input type="text" className="ChatLabelBox" defaultValue='Untitled0' />
