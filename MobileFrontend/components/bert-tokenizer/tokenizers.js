...
export class PreTrainedTokenizer extends Callable {
    ...
    constructor(tokenizerJSON, tokenizerConfig) {
        ...
        this._tokenizer_json = tokenizerJSON.model.vocab;
     ...
     */
    getToken(...keys) {
        // This function only works for single key.
        for (const key of keys) {
            let item = this._tokenizer_config[key];
            if (item === undefined) {item = this._tokenizer_json[key];}
            if (!item) continue;
